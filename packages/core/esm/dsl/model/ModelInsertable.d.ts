...
export type ModelInsertable<V, EnrichmentType> = {
    prototype: V;
} & {
    new ({ context, refName, settings, destinationPath }: ModelInsertableConstructorArgs<EnrichmentType>): V;
    id: string;
    type: 'model';
...
export {};
//# sourceMappingURL=ModelInsertable.d.ts.map