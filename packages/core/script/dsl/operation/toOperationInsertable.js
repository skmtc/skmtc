...
exports.toOperationInsertable = void 0;
const GeneratorKeys_js_1 = require("../../types/GeneratorKeys.js");
const OperationBase_js_1 = require("./OperationBase.js");
const toOperationInsertable = (config) => {
    var _a;
    const OperationInsertable = (_a = class extends OperationBase_js_1.OperationBase {
            constructor(args) {
                super({
                    ...args,
                    generatorKey: (0, GeneratorKeys_js_1.toOperationGeneratorKey)({
...
exports.toOperationInsertable = toOperationInsertable;
