...
exports.toOperationGateway = void 0;
const GatewayBase_js_1 = require("../GatewayBase.js");
const toOperationGateway = (config) => {
    var _a;
    const OperationGateway = (_a = class extends GatewayBase_js_1.GatewayBase {
...
exports.toOperationGateway = toOperationGateway;
