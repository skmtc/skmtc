...
class BaseHandler {
    constructor(levelName, options) {
        ...
        __classPrivateFieldSet(this, _BaseHandler_level, (0, levels_js_1.getLevelByName)(levelName), "f");
    ...
    set level(level) {
        ...
        __classPrivateFieldSet(this, _BaseHandler_levelName, (0, levels_js_1.getLevelName)(level), "f");
    }
    get levelName() {
