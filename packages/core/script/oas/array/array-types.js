...
exports.oasArrayData = zod_openapi_1.z.object({
    oasType: zod_openapi_1.z.literal('schema'),
    // Add soon
    type: zod_openapi_1.z.literal('array'),
    // additionalItems: z.lazy(() => z.union([z.boolean(), jsonSchema4]).optional()),
    items: zod_openapi_1.z.lazy(() => zod_openapi_1.z.union([schema_types_js_1.oasSchemaData, ref_types_js_1.oasSchemaRefData])),
    title: zod_openapi_1.z.string().optional(),
    description: zod_openapi_1.z.string().optional(),
    default: zod_openapi_1.z.array(zod_openapi_1.z.unknown()).optional()
    // Add soon
