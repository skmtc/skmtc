...
class OasRef {
    ...
    resolveOnce() {
        ...
        const refName = (0, refFns_js_1.toRefName)(this.$ref);
        const refType = this.refType;
        const resolved = (0, ts_pattern_1.match)(refType)
    ...
    toRefName() {
        return (0, refFns_js_1.toRefName)(__classPrivateFieldGet(this, _OasRef_fields, "f").$ref);
    }
    get $ref() {
