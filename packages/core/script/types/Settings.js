...
exports.enrichedSetting = zod_1.z
    .object({
    selected: zod_1.z.boolean(),
    enrichments: zod_1.z.unknown().optional()
})
    .openapi('EnrichedSetting');
exports.operationsGeneratorSettings = zod_1.z
    .object({
    id: zod_1.z.string(),
    description: zod_1.z.string().optional(),
    operations: zod_1.z.record(zod_1.z.record(Method_js_1.method, exports.enrichedSetting))
})
    .openapi('OperationsGeneratorSettings');
exports.modelsGeneratorSettings = zod_1.z
    .object({
    id: zod_1.z.string(),
    exportPath: zod_1.z.string().optional(),
    description: zod_1.z.string().optional(),
    models: zod_1.z.record(exports.enrichedSetting)
})
    .openapi('ModelsGeneratorSettings');
exports.clientGeneratorSettings = zod_1.z
    .union([exports.operationsGeneratorSettings, exports.modelsGeneratorSettings])
    .openapi('GeneratorSettings');
exports.modulePackage = zod_1.z
    .object({
    rootPath: zod_1.z.string(),
    moduleName: zod_1.z.string()
})
    .openapi('ModulePackage');
exports.clientSettings = zod_1.z
    .object({
    basePath: zod_1.z.string().optional(),
    packages: zod_1.z.array(exports.modulePackage).optional().openapi('ModulePackages'),
    generators: zod_1.z.array(exports.clientGeneratorSettings)
})
    .openapi('ClientSettings');
exports.skmtcClientConfig = zod_1.z
    .object({
...
exports.skmtcStackConfig = zod_1.z
    .object({
