...
export type GeneratedDefinition<V extends GeneratedValue, T extends GenerationType> = T extends 'force' ? Definition<V> : Definition<V> | undefined;
//# sourceMappingURL=GeneratedValue.d.ts.map