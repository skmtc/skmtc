...
if (args[0] === '--template') {
  ...
  writeFileSync(out, TEMPLATE.replace('__DATA__', 'null').replace('__META__', 'null').replace('__DEEP_THINK_SECONDS__', String(DEEP_THINK_SECONDS)).replace('__DEEP_THINK_TOKENS__', String(DEEP_THINK_TOKENS)))
...
const html = TEMPLATE.replace('__DATA__', escapeForScript(JSON.stringify(events)))
  ...
  .replace('__DEEP_THINK_SECONDS__', String(DEEP_THINK_SECONDS)).replace('__DEEP_THINK_TOKENS__', String(DEEP_THINK_TOKENS))
