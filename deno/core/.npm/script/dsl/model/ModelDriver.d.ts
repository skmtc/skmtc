...
export declare class ModelDriver<V extends GeneratedValue, T extends GenerationType> {
    context: GenerateContext;
    insertable: ModelInsertable<V>;
    refName: RefName;
    ...
    constructor({ context, insertable, refName, generation, destinationPath }: CreateModelArgs<V, T>);
    private apply;
