...
export type TypeSystemValue = TypeSystemArray | TypeSystemIntersection | TypeSystemObject | TypeSystemUnion | TypeSystemString | TypeSystemNumber | TypeSystemInteger | TypeSystemBoolean | TypeSystemUnknown | TypeSystemVoid | TypeSystemRef | TypeSystemNull | TypeSystemCustom;
...
export type TypeSystemOutput<T extends keyof SchemaToTypeSystemMap> = SchemaToTypeSystemMap[T]['output'];
...
export type SchemaToValueFn = <Schema extends SchemaType>(args: TypeSystemArgs<Schema>) => TypeSystemOutput<Schema['type']>;
