...
export class CoreContext {
    ...
    transform({ schema, settings, generatorsMap, prettier }) {
...
}, _CoreContext_setupGeneratePhase = function _CoreContext_setupGeneratePhase({ oasDocument, settings, callback, generatorsMap }) {
