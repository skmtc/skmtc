...
import type { ClientGeneratorSettings, ClientSettings } from '../types/Settings.js';
...
export declare class GenerateContext {
    ...
    captureCurrentResult: (result: ResultType) => void;
    generatorsMap: Record<string, OperationGateway | OperationInsertable<GeneratedValue> | ModelInsertable<GeneratedValue>>;
    constructor({ oasDocument, settings, logger, callback, captureCurrentResult, stackTrail, generatorsMap }: ConstructorArgs);
    /**
     * @internal
     */
     ...
     * @mutates this.files
     */
    insertOperation<V extends GeneratedValue, T extends GenerationType>({ insertable, operation, generation, destinationPath }: InsertOperationArgs<V, T>): Inserted<V, T>;
    /**
     ...
     * @mutates this.files
     */
    insertModel<V extends GeneratedValue, T extends GenerationType>({ insertable, refName, generation, destinationPath }: InsertModelArgs<V, T>): Inserted<V, T>;
    /**
     ...
     * @returns
     */
    toOperationContentSettings<V>({ operation, insertable }: ToOperationSettingsArgs<V>): ContentSettings;
    /**
     ...
     */
    toOperationSelected({ generatorId, path, method }: GetOperationSettingsArgs): boolean | undefined;
