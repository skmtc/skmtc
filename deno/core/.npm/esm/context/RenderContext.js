...
export class RenderContext {
    ...
    trace(token, fn) {
        return tracer(__classPrivateFieldGet(this, _RenderContext_stackTrail, "f"), token, fn);
    }
    getFile(filePath) {
    ...
    addGeneratorKey({ generatorKey }) {
        ...
        invariant(!['PRE_RENDER', 'POST_RENDER'].includes(path), `Cannot add generator key during ${path} phase`);
