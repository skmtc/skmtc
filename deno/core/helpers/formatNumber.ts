 ...
 * 
 * @example Basic formatting with default locale (en-US)
 * ```typescript
 ...
 * ```
 * 
 * @example Formatting decimal numbers (fractional part removed)
 * ```typescript
 ...
 * ```
 * 
 * @example Usage in reporting and statistics
 * ```typescript
 * class StatsReporter {
 ...
 * ```
 * 
 * @example International number formatting
 * ```typescript
 * const count = 50000;
 * 
