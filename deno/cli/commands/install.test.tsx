...
Deno.test('renderInstall - interactive mode mounts the Ink App with the expected state', async () => {
...
Deno.test('renderInstall - missing project name fails with a recipe error in strict mode', async () => {
...
Deno.test('renderInstall - missing generators fails with a recipe error in strict mode', async () => {
  const { errors, exitCode } = await withCapturedExit(async () => {
    await renderInstall({
      projectName: 'my-api',
      generators: undefined,
...
Deno.test('renderInstall - empty generators array also fails (not just undefined)', async () => {
  const { errors, exitCode } = await withCapturedExit(async () => {
    await renderInstall({
      projectName: 'my-api',
      generators: [],
