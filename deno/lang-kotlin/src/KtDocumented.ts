 ...
 * to {@link import('./KtDefinition.ts').KtDefinition} — the fourth
 * value-carried protocol after `KtAnnotated` / `KtSupertyped` /
 * `KtConstructed`, and for the same reason: the neutral
 ...
 * once. The lang renders the KDoc; WHAT the text is (a schema
 * `description`, an operation `summary`) is generator policy.
 *
