...
/**
 * Maps a parsed OAS schema node to its TypeBox snippet.
 */
export const toTypeboxValue: SchemaToValueFn = ({
  ...
  // Widen the generic parameter to the `SchemaType` union so the switch
  // below can narrow each case on its own.
