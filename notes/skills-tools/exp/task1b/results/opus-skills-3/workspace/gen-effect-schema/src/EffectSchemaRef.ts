...
export class EffectSchemaRef extends TsSnippet {
  ...
  override toString(): string {
    ...
    // cycles. effect's `Schema.suspend` needs an explicit return type
    // annotation on the thunk, otherwise the back-reference to a
    // still-being-declared const is a circular inference error.
