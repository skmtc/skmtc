...
export class EffectSchemaUnion extends TsSnippet {
  ...
  override toString(): string {
    ...
    // SLOT(union): oneOf/anyOf syntax. effect's Union is variadic and
    // has no separate discriminated form — it derives discrimination
    // from the members' literal fields — so `this.discriminator` needs
    // no distinct rendering here.
