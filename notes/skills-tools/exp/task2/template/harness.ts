/**
 * Experiment harness (task 2): runs the generator under test over the
 * fixture through the REAL SKMTC pipeline, writes artifacts to ./out/,
 * saves capture.json ({artifacts, inspection}) + manifest.json.
...
import entry from './gen-api-client/mod.ts'
