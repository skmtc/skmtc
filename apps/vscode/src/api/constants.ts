export const SKMTC_ORIGIN = process.env.SKMTC_ORIGIN ?? 'http://127.0.0.1:54321'
export const SKMTC_API = `${SKMTC_ORIGIN}/functions/v1`
export const SKMTC_PUBLIC_ANON_KEY =
